...
FEATURES:
• True Improvisation - Type anything, not just pick from options
• Temperature System - Same scenario, infinite variations
• 4 Scenarios Included - Fantasy, thriller, surreal mystery, corporate drama
• Easy Creation - Simple YAML format, no coding required
• Built-in Tools - Generator, validator, analyzer
...
```
🎮 The AI text adventure engine for Claude Code | ⚡ Adaptive storytelling with temperature control | 🎲 Four scenarios included | 🛠️ Create your own adventures
```
...
```markdown
# 🎮 Introducing Kleene - Adaptive Text Adventures for Claude Code
...
What scenarios will you create? 🎮✨
...
**Discord/Slack:**
```
Just launched Kleene - adaptive text adventures for Claude Code! 🎮
...
• Temp 0: Traditional branching (for first playthrough)
• Temp 5: Balanced adaptation
• Temp 10: Fully emergent storytelling
...
```
🎮 Temperature Experiment Challenge
